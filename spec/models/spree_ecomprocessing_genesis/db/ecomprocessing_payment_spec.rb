RSpec.describe SpreeEcomprocessingGenesis::Db::EcomprocessingPayment do
  ...
  it 'when formatted created_at' do
    expect(ecomprocessing_payment.formatted_created_at).to be_a String
  end

  it 'when formatted updated_at' do
    expect(ecomprocessing_payment.formatted_updated_at).to be_a String
  end
end
