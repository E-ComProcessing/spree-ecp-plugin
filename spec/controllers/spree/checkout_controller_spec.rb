RSpec.describe Spree::CheckoutController, :vcr, type: :controller do
  ...
  describe 'when create_payment' do
    describe 'when ecomprocessing checkout' do
      let(:gateway) { create :ecomprocessing_checkout_gateway }
      ...
      it 'with successful response' do
        ...
        expect(response)
          .to redirect_to 'https://staging.wpf.e-comprocessing.net/en/v2/payment/9aed8de9319c4c3806a9d1614797f853'
      end
    ...
    describe 'when ecomprocessing direct' do
      ...
      it 'with successful response' do
        post :update, params: params
        expect(response).to redirect_to 'http://127.0.0.1:4000/ecomprocessing_threeds/' \
