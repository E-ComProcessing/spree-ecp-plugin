RSpec.describe Spree::Api::V2::Storefront::EcomprocessingNotificationController, :vcr, type: :controller do
  ...
  describe 'when valid request' do
    ...
    describe 'when wpf notification' do
      ...
      let(:create_payment) do
        create :ecomprocessing_checkout_payment,
      ...
      describe 'when authorized mobile payment' do # rubocop:disable RSpec/NestedGroups
        let(:payment) do
          create :spree_payment,
                 payment_method: create(:ecomprocessing_checkout_gateway, transaction_types: %w(google_pay_authorize)),
                 source: create(:ecomprocessing_checkout_source)
        end
      ...
      describe 'when sale mobile payment' do # rubocop:disable RSpec/NestedGroups
        let(:payment) do
          create :spree_payment,
                 payment_method: create(:ecomprocessing_checkout_gateway, transaction_types: %w(apple_pay_sale)),
                 source: create(:ecomprocessing_checkout_source)
        end
      ...
      describe 'when express mobile payment' do # rubocop:disable RSpec/NestedGroups
        let(:payment) do
          create :spree_payment,
                 payment_method: create(:ecomprocessing_checkout_gateway, transaction_types: %w(pay_pal_express)),
                 source: create(:ecomprocessing_checkout_source)
        end
