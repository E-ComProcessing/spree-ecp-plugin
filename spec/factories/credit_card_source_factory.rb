FactoryBot.define do
  ...
  factory :spree_credit_card, parent: :credit_card_params, class: 'Spree::CreditCard' do
    before(:create) do |object|
      object.payment_method = create(:ecomprocessing_direct_gateway)
    end
  end

  factory :ecomprocessing_credit_card_source, class: 'SpreeEcomprocessingGenesis::Sources::CreateCreditCard' do
    transient do
      payment_method
      user
    end
