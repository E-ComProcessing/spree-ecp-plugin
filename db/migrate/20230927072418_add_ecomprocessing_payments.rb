...
class AddEcomprocessingPayments < ActiveRecord::Migration[6.1]

  def up # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
    create_table 'ecomprocessing_payments', if_not_exists: true do |t|
  ...
  def down
    drop_table 'ecomprocessing_payments'
  end
