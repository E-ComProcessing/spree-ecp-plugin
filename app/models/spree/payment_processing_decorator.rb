module Spree
  # Ecomprocessing Payment Processing decorator
  module PaymentProcessingDecorator
    ...
    def gateway_action(source, action, success_state)
      protect_from_connection_error do
        ...
        result        = SpreeEcomprocessingGenesis::TransactionHelper.generate_spree_response response
    ...
    def fetch_state(current_state, response, action)
      ...
      return 'started_processing' if SpreeEcomprocessingGenesis::TransactionHelper.async_result?(response)
