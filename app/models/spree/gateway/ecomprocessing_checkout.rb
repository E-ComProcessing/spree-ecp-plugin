module Spree
  ...
  class Gateway::EcomprocessingCheckout < SpreeEcomprocessingGenesis::Base::Gateway # rubocop:disable Style/ClassAndModuleChildren

    preference :transaction_types, :multi_select,  default: lambda {
      {
        values:   SpreeEcomprocessingGenesis::PaymentMethodHelper.fetch_wpf_transaction_types,
