module SpreeEcomprocessingGenesis
  module Base
    ...
    class Gateway < Spree::Gateway
      ...
      def provider_class
        SpreeEcomprocessingGenesis::GenesisProvider
      end
      ...
      def capture(amount, transaction_id, gateway_options)
        ...
        transaction = SpreeEcomprocessingGenesis::EcomprocessingPaymentsRepository.find_by_transaction_id transaction_id
      ...
      def void(transaction_id, gateway_options)
        ...
        transaction = SpreeEcomprocessingGenesis::EcomprocessingPaymentsRepository.find_final_transaction transaction_id
