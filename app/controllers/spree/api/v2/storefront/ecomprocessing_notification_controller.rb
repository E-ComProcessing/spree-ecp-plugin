module Spree
  module Api
    module V2
      module Storefront
        # Ecomprocessing IPN Controller handler
        class EcomprocessingNotificationController < ::Spree::Api::V2::BaseController
          ...
          def index
            ...
            notification = SpreeEcomprocessingGenesis::Notifications::ServiceHandler.call permitted_params
