  ...
  module Threeds
    ...
    class Callback < Base::PaymentService
      ...
      def store_callback_status
        ...
        ecomprocessing_payment.callback_status = params[:threeds_method_status]
      ...
      def fetch_callback_status
        ecomprocessing_payment.callback_status.to_s
      end
      ...
      def process_method_continue
        ...
        handle_method_continue_response genesis_provider.method_continue(ecomprocessing_payment)
      rescue StandardError => e
        Rails.logger.error e.message
