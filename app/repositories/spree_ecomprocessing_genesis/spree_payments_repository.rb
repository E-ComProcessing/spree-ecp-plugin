  ...
  class SpreePaymentsRepository
    ...
    class << self
      ...
      def capturable_type?(payment, transaction_type)
        ...
        if SpreeEcomprocessingGenesis::Mappers::Transaction::MOBILE_TYPES.include? transaction_type
      ...
      def mobile_authorize_type?(payment, transaction_type)
        transaction_helper    = SpreeEcomprocessingGenesis::Mappers::Transaction
        selected_mobile_types = SpreeEcomprocessingGenesis::PaymentMethodHelper.fetch_wpf_mobile_types(
